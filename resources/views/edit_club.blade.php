...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">{{ __('Редагувати клуб') }}</div>

        <div class="card-body">
          <form method="POST" enctype="multipart/form-data"
                action="/admin/clubs/{{ $club->id }}">
            @csrf
            @method('patch')
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="name" type="text"
                 ...
                 name="name" value="{{ old('name') ?? $club->name }}"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="street" type="text"
                 ...
                 name="street" value="{{ old('street') ?? $club->street }}"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="house" type="text"
                 ...
                 name="house" value="{{ old('house') ?? $club->house }}"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="flat" type="text"
                 ...
                 name="flat" value="{{ old('flat') ?? $club->flat }}"
